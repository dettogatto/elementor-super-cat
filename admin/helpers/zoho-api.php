...
class Zoho_Api_By_Gatto {
  ...
  private $option_prefix = "elementor_super_cat_zoho_";

  function __construct(){
    $this->ZOHOuseremail = get_option($this->option_prefix . "client_email");
    $this->ZOHOconfigarray = array(
      "client_id" => get_option($this->option_prefix . "client_id"),
      "client_secret" => get_option($this->option_prefix . "client_secret"),

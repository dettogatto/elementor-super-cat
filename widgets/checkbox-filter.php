...
class Checkbox_Filter extends \Elementor\Widget_Base {
  ...
  public function __construct($data = [], $args = null) {
    ...
    wp_register_script( 'checkbox-filter-js', plugins_url( '/assets/js/checkbox-filter.js', __DIR__ ), [ 'jquery' ], null, true );
    wp_register_style( 'checkbox-filter-css', plugins_url( '/assets/css/checkbox-filter.css', __DIR__ ));
  }
